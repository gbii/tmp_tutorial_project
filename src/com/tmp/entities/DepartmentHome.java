...
// Generated Dec 28, 2015 2:52:48 PM by Hibernate Tools 4.3.1.Final
 ...
 * @see com.tmp.entities.Department
...
public class DepartmentHome {
	...
	public Department findById(int id) {
		...
		try {
			Department instance = (Department) sessionFactory.getCurrentSession().get("com.tmp.entities.Department",
					id);
			if (instance == null) {
	...
	public List findByExample(Department instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.tmp.entities.Department")
