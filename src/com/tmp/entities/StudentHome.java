...
public class StudentHome {
	...
	public Student findById(long id) {
		...
		try {
			Student instance = (Student) sessionFactory.getCurrentSession().get("com.tmp.entities.Student", id);
			if (instance == null) {
	...
	public List findByExample(Student instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.tmp.entities.Student")
