...
public class TeacherHome {
	...
	public Teacher findById(long id) {
		...
		try {
			Teacher instance = (Teacher) sessionFactory.getCurrentSession().get("com.tmp.entities.Teacher", id);
			if (instance == null) {
	...
	public List findByExample(Teacher instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.tmp.entities.Teacher")
